...
FTABLE_SCENE_INDEP()
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                "320x240","640x480","1024x768","1280x768","1280x960","1600x1200","2048x1536","2200x1320","2880x1728","2560x1920"/*      "2560x1920",*/ /*zhao.li@tcl 13.6.29 add 1280x768 "2560x1536"for Bug 480655*/
            )
        ), 
    )
#endif

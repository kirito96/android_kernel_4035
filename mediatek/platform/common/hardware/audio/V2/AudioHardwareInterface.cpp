...
static const char *displayMode(int mode)
{
    ...
    switch(mode)
    {
        case AudioSystem::MODE_INVALID:
                return routingModeStrings[1];
        case AudioSystem::MODE_CURRENT:
                return routingModeStrings[2];
        case AudioSystem::MODE_NORMAL:
                return routingModeStrings[3];
        case AudioSystem::MODE_RINGTONE:
                return routingModeStrings[4];
        case AudioSystem::MODE_IN_CALL:
        case AudioSystem::MODE_IN_CALL_2:    
        case AudioSystem::MODE_IN_CALL_EXTERNAL:
                return routingModeStrings[5];
        case AudioSystem::MODE_IN_COMMUNICATION:        
                return routingModeStrings[6];
        default:

...
AudioMTKPolicyManager::routing_strategy AudioMTKPolicyManager::getStrategy(
    ...
    case AudioSystem::ALARM:
        //add by Rock.Song for PR595805 @20140211{
        char sound_device_mode[PROPERTY_VALUE_MAX];
        property_get("persist.sys.sound_device_mode", sound_device_mode, NULL);
        if(!strcmp(sound_device_mode, "true")){
